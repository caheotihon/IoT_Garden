                      ...
                      child: Column(
                        children: [
                          _ControlCard(
                            ...
                            value: controller.pumpState == 'on',
                            onChanged: controller.brokerConnected && controller.deviceOnline
                                ? (value) => controller.toggleDevice('pump')
                                : null,
                            subtitle: 'Status: ${controller.pumpState.toUpperCase()}',
                            activeGradient: [Colors.blue.shade400, Colors.blue.shade600],
                          ),
                          ...
                          _ControlCard(
                            ...
                            value: controller.ledState == 'on',
                            onChanged: controller.brokerConnected && controller.deviceOnline
                                ? (value) => controller.toggleDevice('light')
                                : null,
                            subtitle: 'Status: ${controller.ledState.toUpperCase()}',
...
class MqttController extends ChangeNotifier {
  ...
  static const String topicNamespace = 'demo/garden'; // Match other components
  ...
  String get pumpState => _pumpState;
  String get ledState => _ledState;
  ...
  void _handleOnlineStatus(Map<String, dynamic> data) {
    ...
    if (data.containsKey('firmware')) {
      _firmware = data['firmware'].toString();
    }
    if (data.containsKey('rssi')) {
      _rssi = data['rssi'].toString();
    }
